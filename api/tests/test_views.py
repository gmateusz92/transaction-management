...
class TransactionViewsTest(APITestCase):
    ...
    def test_get_transactions(self):
        ...
        self.assertEqual(response.data['transactions'][0]['amount'], str(self.transaction.amount))
    ...
    def test_add_transaction(self):
        ...
        self.assertEqual(Transaction.objects.count(), 2)  #  Checking whether new transaction was added
    ...
    def test_update_transaction(self):
        ...
        self.assertEqual(self.transaction.description, "Updated transaction description")

    def test_delete_transaction(self):
        url = reverse('delete-transaction', args=[self.transaction.id])
        response = self.client.delete(url)
        self.assertEqual(response.status_code, status.HTTP_204_NO_CONTENT)
        self.assertEqual(Transaction.objects.count(), 0)  # Checking if transaction was deleted
